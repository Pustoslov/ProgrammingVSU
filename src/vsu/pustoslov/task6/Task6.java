...
public class Task6 {
    ...
    private static PrintResult countRow(double x, int n, double e) {
        ...
        return new PrintResult(sumOfRowN, sumOfRowMoreThanE, sumOfRowETen);
    }
